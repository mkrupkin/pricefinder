...
Локація користувача: {$location}
Поточний рік: " . date('Y') . "

МІСІЯ ПОШУКУ:
Знайдіть ВСІ можливі місця купівлі '{$query}' через різні канали:

🌍 ПОВНЕ СКАНУВАННЯ РИНКУ:
1. Офіційні виробники та брендові магазини
2. Великі ритейлери (онлайн + фізичні)
3. Локальні магазини та регіональні мережі
4. Marketplace платформи (eBay, Amazon, Prom.ua, OLX)
5. Соціальна комерція (Facebook, Instagram, Telegram канали)
6. Оптові та B2B постачальники
7. Спеціалізовані нішеві платформи
8. Аукціони та біржі
9. Ринки вживаних та відновлених товарів
10. Міжнародні магазини з доставкою
11. Транскордонні торгові можливості
12. Локальні оголошення та форуми

🎯 ГЕОГРАФІЧНІ ПРІОРИТЕТИ:
- Пріоритет 1: Локальні магазини в {$location} (50%)
- Пріоритет 2: Національні ритейлери (30%)
- Пріоритет 3: Міжнародні з доставкою (20%)

📊 ВИМОГИ ДО РЕЗУЛЬТАТІВ:
- 15-30 детальних результатів
- Реалістичні ціни для " . date('Y') . " року
- Повна контактна інформація
- Варіанти доставки та оплати
- Оцінка надійності магазину
- Спеціальні пропозиції

Якщо запит продукту неясний або занадто загальний:
- Задайте питання для уточнення
- Запропонуйте популярні варіанти
- Дайте рекомендації по категоріях

ВІДПОВІДЬ У ТОМУ Ж JSON ФОРМАТІ ЩО Й ДЛЯ АНАЛІЗУ ЗОБРАЖЕНЬ.
";
    }
